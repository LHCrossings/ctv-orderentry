...
# changes.
_SCAN_CACHE_VERSION = 10  # v10: IW Group / Covered California TELEVISION ORDER (text + CCA_ filename); v9: Admerasia detects any Ref:/Order Number IO (SMG); v8: San Joaquin County xlsx/filename rule; v7: Wallrich PDF rule client-keyed too; opAD excludes KBTV
